...
def main():
    ...
    parser.add_argument("--mtrace-log", default="/tmp/ace-mtrace.log", help="Path to the mtrace log file.")
    parser.add_argument("--exec-log", default="/tmp/qemu-exec.log", help="Path to the QEMU execution log (passed to -D).")
