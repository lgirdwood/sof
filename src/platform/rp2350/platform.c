...
LOG_MODULE_REGISTER(rp2350_platform, CONFIG_SOF_LOG_LEVEL);

uint8_t sof_rp2350_mailbox[0x1000] __aligned(32);
...
int platform_boot_complete(uint32_t boot_message)
{
	...
	LOG_INF("RP2350 platform boot complete");
	return 0;
}
...
{
	LOG_INF("Initializing RP2350 SOF Platform...");
	...
	LOG_INF("RP2350 SOF Platform initialized successfully");
	return 0;
}
